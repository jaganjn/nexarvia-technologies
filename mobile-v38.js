...
if(type==='home')items=[{href:'index.html',icon:'home',label:'Home'},{href:'technology-services.html',icon:'services',label:'Services'},{href:'#mission',icon:'journey',label:'Mission'},{href:'#contact',icon:'enquiry',label:'Contact'}];

(() => {
  ...
  if(window.db && typeof window.db.ref === 'function'){window.db.ref('publicAnnouncements').on('value',s=>renderNotices(Object.values(s.val()||{})),()=>renderNotices([]))}else renderNotices([]);
